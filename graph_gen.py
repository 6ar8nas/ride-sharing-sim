...
def map_to_graph(
    location_name: str, screen_bounds: Tuple[int, int] = (800, 600)
) -> Tuple[rx.PyGraph, dict[int, Tuple[float, float]], dict[Tuple[int, int], float]]:
    G = ox.graph_from_place(
        location_name,
        network_type="drive",
        custom_filter='["highway"~"motorway|trunk|primary|secondary|teriatry"]',
    )
